...
% % % % % % % % % % % % % % % 
	...
	\begin{flushleft}
		\begin{figure}[ht!]
			\fbox{\includegraphics[width=2in, height=2in]{./Fotos/}}
		\end{figure}
	\end{flushleft}
	...
	\begin{minipage}{0.26\linewidth}
		...
		Hard worker, good follower as well as the capability to lead, excellent people skills. \\
		Never backs down from a challenge, always willing to help. \\
