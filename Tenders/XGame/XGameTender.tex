...
\epigraph{ Tender application for XGame presented by Derivco. The purpose of this document is to give an overview of why we should be awarded the project \\ and how we aim to achieve success and complete the project.}%
{\textit{ 2014 }\\ \textsc{ }}
\null\vfill
\vspace*{4cm}
\noindent
...
% % % % % % % % % % % % % % % 
	...
	\newpage
		...
		\section*{\colorbox{blue}{\makebox[\textwidth-2\fboxsep][l]{\bfseries\color{white} Group Information }}} \addcontentsline{toc}{section}{Group Information}
		
		\vspace{0.2in}
		
		\textbf{Here is some information about the group:}
		\\\linebreak
		...
		\\\linebreak
		\textbf{The rest of our individual information can be found in the team portfolio.}
